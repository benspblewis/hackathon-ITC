      ...
      <Box textAlign="center">
        <Flex flexWrap="wrap">
          <Text fontSize="xl" ml={10} mr={10}>
            Welcome to LingoChat. LingoChat is the social application that connects the diverse cultures that make up our society.
            Create an account and discover the new way to interact with people.
          </Text>
        </Flex>
      </Box>
